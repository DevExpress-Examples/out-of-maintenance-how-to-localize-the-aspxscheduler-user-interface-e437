...
<%@ Control Language="vb" AutoEventWireup="true" CodeFile="AppointmentForm_v8_2.de-DE.ascx.vb" Inherits="AppointmentFormDE" %>
			...
			<table class="dxscLabelControlPair" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td style="padding-left: 2px;">
						<dxe:ASPxLabel ID="lblAllDay" runat="server" Text="Ganztagig" AssociatedControlID="chkAllDay" />
					</td>
				</tr>
			</table>
		</td>
		...
		<td style="width: 100%; height: 100%;" align="center">
			<table style="height: 100%;">
				<tr>
					...
					<td>
						<dxe:ASPxButton runat="server" ClientInstanceName="_dx" ID="btnDelete" Text="Loschen" UseSubmitBehavior="false"
