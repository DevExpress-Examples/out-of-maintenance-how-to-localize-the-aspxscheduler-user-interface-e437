...
{************************************************************************************}
--%>
<%@ Control Language="vb" AutoEventWireup="true" Inherits="CustomForms_HorizontalSameDayAppointmentTemplate" CodeFile="HorizontalSameDayAppointmentTemplate_v10_1.it.ascx.vb" %>
