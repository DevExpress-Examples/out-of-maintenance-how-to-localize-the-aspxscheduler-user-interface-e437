...
<%@ Control Language="vb" AutoEventWireup="true" Inherits="AppointmentForm" CodeFile="AppointmentForm_v8_3.de-DE.ascx.vb" %>
		...
		<td style="width: 100%; height: 100%;" align="center">
			<table style="height: 100%;">
				<tr>
					...
					<td>
						<dxe:ASPxButton runat="server" ClientInstanceName="_dx" ID="btnDelete" Text="L?schen" UseSubmitBehavior="false"
