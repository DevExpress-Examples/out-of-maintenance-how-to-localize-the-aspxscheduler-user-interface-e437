...
{************************************************************************************}
--%>
<%@ Control Language="vb" AutoEventWireup="true" Inherits="CustomForms_RecurrentAppointmentDeleteForm" CodeFile="RecurrentAppointmentDeleteForm_v10_2.it.ascx.vb" %>
...
<table style="width:100%; height:100%">
	<tr>
		...
		<td style="width:100%;">
			<dxe:ASPxLabel ID="lblConfirm" runat="server" Text='<%#"Eliminare tutte le occorrenze dell&#039;appuntamento """ & (CType(Container, DevExpress.Web.ASPxScheduler.RecurrentAppointmentDeleteFormTemplateContainer)).Appointment.Subject & """, o solo una?"%>'/>
		</td>
	</tr>
	<tr>
		<td style="width:100%;">
