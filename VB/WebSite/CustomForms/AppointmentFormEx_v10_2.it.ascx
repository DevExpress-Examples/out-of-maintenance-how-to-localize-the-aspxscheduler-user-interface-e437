...
<%@ Control Language="vb" AutoEventWireup="true" Inherits="CustomForms_AppointmentFormEx" CodeFile="AppointmentFormEx_v10_2.it.ascx.vb" %>
                ...
                <tr>
                    <td class="dxscLabelCell">
                        <dxe:ASPxLabel ID="lblStartDate" runat="server" 
                            AssociatedControlID="edtStartDate" Text="Ora fine:" Wrap="false">
                        </dxe:ASPxLabel>
                    </td>
                    <td class="dxscControlCell">
                        <dxe:ASPxDateEdit ClientInstanceName="_dx" ID="edtStartDate" runat="server" Width="100%" 
Date='<%#CType(Container, AppointmentFormTemplateContainer).Start%>' EditFormat="DateTime" DateOnError="Undo" AllowNull="false"/> 
                    </td>
                </tr>
            </table>
        </td>
        <td class="dxscSingleCell">
            <table class="dxscLabelControlPair" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="dxscLabelCell" style="padding-left: 25px;">
                        <dxe:ASPxLabel runat="server" ID="lblEndDate" Text="Ora fine:" Wrap="false" 
                            AssociatedControlID="edtEndDate"/>
                    </td>
                    <td class="dxscControlCell">
                        <dxe:ASPxDateEdit id="edtEndDate" runat="server" 
Date='<%#CType(Container, AppointmentFormTemplateContainer).End%>'
            ...
            <table class="dxscLabelControlPair" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="width: 20px; height: 20px;">
                        <dxe:ASPxCheckBox ClientInstanceName="_dx" ID="chkAllDay" runat="server" 
Checked='<%#CType(Container, AppointmentFormTemplateContainer).Appointment.AllDay%>' />
                    </td>
                    <td style="padding-left: 2px;">
                        <dxe:ASPxLabel ID="lblAllDay" runat="server" Text="Giornata intera" 
                            AssociatedControlID="chkAllDay" />
                    </td>
                </tr>
            </table>
        </td>
                ...
                <tr>
                    <td class="dxscLabelCell">
                        <dxe:ASPxLabel ID="lblResource" runat="server" 
                            AssociatedControlID="edtResource" Text="Risorse:">
                        </dxe:ASPxLabel>
                    </td>
                    <td class="dxscControlCell">
                        <%
                        ...
                        %>
                        <dxe:ASPxDropDownEdit id="ddResource" runat="server" Width="100%" ClientInstanceName="ddResource" 
Enabled='<%#CType(Container, AppointmentFormTemplateContainer).CanEditResource%>' AllowUserInput="false">
                            <DropDownWindowTemplate>
                                <dxe:ASPxListBox id="edtMultiResource" runat="server" width="100%" SelectionMode="CheckColumn" 
...
DataSource='<%#ResourceDataSource%> ' Enabled='<%#CType(Container, AppointmentFormTemplateContainer).CanEditResource%>' />
<%
End If
%>
                    </td>
                    ...
                    <td class="dxscLabelCell" style="padding-left: 22px;">
                        <table class="dxscLabelControlPair" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="padding-left: 2px;">
                                    <dxe:ASPxLabel ID="lblReminder" runat="server" Text="Promemoria" 
                                        AssociatedControlID="chkReminder" />
                                </td>
                            </tr>
                        </table>
                    </td>
...
DataSource='<%#CType(Container, AppointmentFormTemplateContainer).ReminderDataSource%>' />
                    </td>
                </tr>
            </table>
        </td>
...
%>
    ...
    <tr>
        <td class="dxscDoubleCell" colspan="2" style="height: 90px;">
            <dxe:ASPxMemo ClientInstanceName="_dx" ID="tbDescription" runat="server" Width="100%" Rows="6" 
Text='<%#CType(Container, AppointmentFormTemplateContainer).Appointment.Description%>' />
        </td>
    </tr>
</table>
...
<table>
    <tr>
        <td  class="dxscDoubleCell" colspan="2">
            <dxe:ASPxCheckBox ID="chkRecurrence" runat="server" Text="Ricorrenza" 
                Checked='<%#CType(Container, AppointmentFormTemplateContainer).Appointment.IsRecurring%>'>
                <ClientSideEvents CheckedChanged="function(s,e) { if (s.GetChecked()) 
{ if (RecurrencePanel.mainElement.innerHTML.replace(/^\s*(\b.*\b|)\s*$/, '') == '') RecurrencePanel.PerformCallback(); 
else RecurrencePanel.SetVisible(true); } else RecurrencePanel.SetVisible(false); }" 
                />
            </dxe:ASPxCheckBox>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButton runat="server" ClientInstanceName="_dx" ID="btnCancel" 
                            Text="Annulla" UseSubmitBehavior="false" AutoPostBack="false" EnableViewState="false" 
                            Width="91px" CausesValidation="False" />
                    </td>
                    <td>
                        <dxe:ASPxButton runat="server" ClientInstanceName="_dx" ID="btnDelete" 
                            Text="Elimina" UseSubmitBehavior="false"
