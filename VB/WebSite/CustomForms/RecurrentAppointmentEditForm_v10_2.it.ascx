...
{************************************************************************************}
--%>
<%@ Control Language="vb" AutoEventWireup="true" Inherits="CustomForms_RecurrentAppointmentEditForm" CodeFile="RecurrentAppointmentEditForm_v10_2.it.ascx.vb" %>
...
<table style="width:100%; height:100%">
    <tr>
        ...
        <td style="width:100%;">
            <dxe:ASPxLabel ID="lblConfirm" runat="server" Text='<%#CType(Container, DevExpress.Web.ASPxScheduler.RecurrentAppointmentEditFormTemplateContainer).Appointment.Subject & " un appuntamento ricorrente. Aprire l&#039;occorrenza o l&#039;intera serie?"%>'/>
        </td>
    </tr>
    <tr>
        <td style="width:100%;">
