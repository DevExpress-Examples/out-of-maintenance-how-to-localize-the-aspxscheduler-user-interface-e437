...
<table cellpadding="2"; cellspacing="0" style="width:100%; height:100%">
	<tr>
		<td style="width:100%" >
			<dxe:ASPxMemo ClientInstanceName="_dx" ID="memSubject" runat="server" Width="100%" Rows="4" Text='<%#(CType(Container, AppointmentInplaceEditorTemplateContainer)).Appointment.Subject%>'></dxe:ASPxMemo>
		</td>
		<td valign="top" >
		<div>
			<cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnSave" Width="19px" Height="19px" ToolTip="Save" 
				...
				OnClientClick='<%#(CType(Container, AppointmentInplaceEditorTemplateContainer)).SaveHandler%>' >
