...
public partial class VerticalAppointmentTemplate : System.Web.UI.UserControl {
	...
	protected void Page_Load(object sender, EventArgs e) {
		...
		lblStartTime.ControlStyle.CopyFrom(Items.StartTimeText.Style);
		lblEndTime.ControlStyle.CopyFrom(Items.EndTimeText.Style);
		lblTitle.ControlStyle.CopyFrom(Items.Title.Style);		
		lblDescription.ControlStyle.CopyFrom(Items.Description.Style);
