...
{************************************************************************************}
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecurrentAppointmentEditForm.ascx.cs" Inherits="RecurrentAppointmentEditForm" %>
    ...
    <tr>
        <td align="center" style="width:100%" colspan="2">
            <table>
                <tr>
                    <td>
                        <dxe:ASPxButton ID="btnOk" ClientInstanceName="_dx" runat="server" Text="OK" UseSubmitBehavior="false" AutoPostBack="false" EnableViewState="false" Width="91px" OnClientClick='<%# ((DevExpress.Web.ASPxScheduler.RecurrentAppointmentEditFormTemplateContainer)Container).ApplyHandler %>' />
                    </td>
                    <td>
                        <dxe:ASPxButton ID="btnCancel" ClientInstanceName="_dx" runat="server" Text="Cancel" UseSubmitBehavior="false" AutoPostBack="false" EnableViewState="false" 
                            Width="91px" CausesValidation="False" OnClientClick='<%# ((DevExpress.Web.ASPxScheduler.RecurrentAppointmentEditFormTemplateContainer)Container).CancelHandler %>' />
                    </td>
                </tr>
            </table>
        </td>
