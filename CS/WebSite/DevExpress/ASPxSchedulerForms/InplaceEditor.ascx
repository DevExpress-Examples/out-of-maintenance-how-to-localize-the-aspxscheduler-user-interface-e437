...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InplaceEditor.ascx.cs" Inherits="InplaceEditor" %>
...
<table cellpadding="2"; cellspacing="0" style="width:100%; height:100%">
    <tr>
        <td style="width:100%" >
            <dxe:ASPxMemo ClientInstanceName="_dx" ID="memSubject" runat="server" Width="100%" Rows="4" Text='<%#((AppointmentInplaceEditorTemplateContainer)Container).Appointment.Subject %>'></dxe:ASPxMemo>
        </td>
        <td valign="top" >
        <div>
            <cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnSave" Width="19px" Height="19px" ToolTip="Save" 
                ...
                OnClientClick='<%#((AppointmentInplaceEditorTemplateContainer)Container).SaveHandler %>' >
        ...
        <div>
            <cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnCancel" Width="19px" Height="19px" ToolTip="Cancel" 
                ...
                OnClientClick='<%#((AppointmentInplaceEditorTemplateContainer)Container).CancelHandler %>'
        ...
        <div>
            <cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnEditForm" Width="19px" Height="19px" ToolTip="Open Edit Form..." 
                ...
                OnClientClick='<%#((AppointmentInplaceEditorTemplateContainer)Container).EditFormHandler %>'
                CausesValidation="False">
             <Image Height="19px" Width="19px" />
            </cc1:NoBorderButton>
        </div>
