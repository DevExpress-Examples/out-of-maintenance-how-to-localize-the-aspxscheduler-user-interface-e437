...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="CustomForms_GotoDateForm" CodeFile="GotoDateForm_v9_3.it.ascx.cs" %>
...
<table style="width:100%; height:100%">
    <tr>
        <td>
            <dxe:ASPxLabel ID="lblDate" runat="server" Text="Data:" />
        </td>
        <td style="width:100%">
    ...
    <tr>
        <td>
            ...
            <dxe:ASPxLabel ID="lblView" runat="server" Text="Visualizza in:"></dxe:ASPxLabel>
            </span>
        </td>
        <td style="width:100%">
