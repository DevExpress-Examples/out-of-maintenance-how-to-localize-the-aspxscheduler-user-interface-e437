...
{************************************************************************************}
--%>
<%@ Control Language="C#" AutoEventWireup="true" Inherits="CustomForms_RecurrentAppointmentEditForm" CodeFile="RecurrentAppointmentEditForm_v9_3.it.ascx.cs" %>
...
<table style="width:100%; height:100%">
    <tr>
        ...
        <td style="width:100%;">
            <dxe:ASPxLabel ID="lblConfirm" runat="server" Text='<%# ((DevExpress.Web.ASPxScheduler.RecurrentAppointmentEditFormTemplateContainer)Container).Appointment.Subject + " un appuntamento ricorrente. Aprire l&#039;occorrenza o l&#039;intera serie?" %>'/>
        </td>
    </tr>
    <tr>
        <td style="width:100%;">
            <dxe:ASPxRadioButtonList ID="rbAction" runat="server" ValueType="System.Int32" SelectedIndex="0">
                                ...
                                <Items>
                                    <dxe:ListEditItem Text="Apri serie" Value="1" />
                                    <dxe:ListEditItem Text="Apri l'occorrenza" Value="2" />
                                </Items>
