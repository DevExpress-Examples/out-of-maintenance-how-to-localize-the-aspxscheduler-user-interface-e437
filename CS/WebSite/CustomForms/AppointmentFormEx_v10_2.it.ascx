...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="CustomForms_AppointmentFormEx" CodeFile="AppointmentFormEx_v10_2.it.ascx.cs" %>
...
Date='<%# ((AppointmentFormTemplateContainer)Container).Start %>' EditFormat="DateTime" DateOnError="Undo" AllowNull="false"/> 
                    </td>
                </tr>
            </table>
        </td>
...
Date='<%# ((AppointmentFormTemplateContainer)Container).End %>'
...
Checked='<%# ((AppointmentFormTemplateContainer)Container).Appointment.AllDay %>' />
                    </td>
...
Enabled='<%# ((AppointmentFormTemplateContainer)Container).CanEditResource %>' AllowUserInput="false">
...
DataSource='<%# ResourceDataSource %> ' Enabled='<%# ((AppointmentFormTemplateContainer)Container).CanEditResource %>' />
<% } %>             
                    </td>
                </tr>
            </table>
...
Text='<%# ((AppointmentFormTemplateContainer)Container).Appointment.Description %>' />
        </td>
    </tr>
</table>
    ...
    <tr>
        <td  class="dxscDoubleCell" colspan="2">
            <dxe:ASPxCheckBox ID="chkRecurrence" runat="server" Text="Ricorrenza" 
                Checked='<%# ((AppointmentFormTemplateContainer)Container).Appointment.IsRecurring %>'>
