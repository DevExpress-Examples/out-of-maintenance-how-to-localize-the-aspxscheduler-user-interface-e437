...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="CustomForms_InplaceEditor" CodeFile="InplaceEditor_v9_3.it.ascx.cs" %>
...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v9.3, Version=9.3.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxScheduler.Controls"
    TagPrefix="cc1" %>
...
<table cellpadding="2"; cellspacing="0" style="width:100%; height:100%">
    <tr>
        ...
        <div>
            <cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnSave" Width="19px" Height="19px" ToolTip="Salva" 
                Image-IsResourcePng="True">
            </cc1:NoBorderButton> 
        </div>
        
        <div style="padding-top:1px;">
            <cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnCancel" Width="19px" Height="19px" ToolTip="Annulla" 
                 CausesValidation="False" Image-IsResourcePng="True">
            </cc1:NoBorderButton> 
        </div>

        <div style="padding-top:6px;">
            <cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnEditForm" Width="19px" Height="19px" ToolTip="Apri la maschera di modifica..." 
                CausesValidation="False" Image-IsResourcePng="True">
            </cc1:NoBorderButton>
        </div>
        </td>
