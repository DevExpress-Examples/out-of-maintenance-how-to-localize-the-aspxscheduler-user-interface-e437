...
{************************************************************************************}
--%>
<%@ Control Language="C#" AutoEventWireup="true" Inherits="CustomForms_RecurrentAppointmentDeleteForm" CodeFile="RecurrentAppointmentDeleteForm_v9_3.it.ascx.cs" %>
...
<table style="width:100%; height:100%">
    <tr>
        ...
        <td style="width:100%;">
            <dxe:ASPxLabel ID="lblConfirm" runat="server" Text='<%# "Eliminare tutte le occorrenze dell&#039;appuntamento \"" + ((DevExpress.Web.ASPxScheduler.RecurrentAppointmentDeleteFormTemplateContainer)Container).Appointment.Subject + "\", o solo una?"%>'/>
        </td>
    </tr>
    <tr>
        <td style="width:100%;">
            <dxe:ASPxRadioButtonList ID="rbAction" runat="server" ValueType="System.Int32" SelectedIndex="0">
                                ...
                                <Items>
                                    <dxe:ListEditItem Text="Elimina la serie" Value="1" />
                                    <dxe:ListEditItem Text="Elimina l'occorrenza" Value="2" />
                                </Items>
        ...
        <td align="center" style="width:100%" colspan="2">
            <table>
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButton ID="btnCancel" ClientInstanceName="_dx" runat="server" 
