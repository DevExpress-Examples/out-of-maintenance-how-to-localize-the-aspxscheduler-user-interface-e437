...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AppointmentForm_v8_2.de-DE.ascx.cs" Inherits="AppointmentFormDE" %>
                ...
                <tr>
                    <td>
                        <dxe:ASPxButton runat="server" ClientInstanceName="_dx" ID="btnOk" Text="OK" UseSubmitBehavior="false" AutoPostBack="false" 
                            EnableViewState="false" Width="91px" OnClientClick='<%# ((AppointmentFormTemplateContainer)Container).SaveHandler %>' />
                    </td>
                    <td>
                        <dxe:ASPxButton runat="server" ClientInstanceName="_dx" ID="btnCancel" Text="Abbrechen" UseSubmitBehavior="false" AutoPostBack="false" EnableViewState="false" 
                            Width="91px" CausesValidation="False" OnClientClick='<%# ((AppointmentFormTemplateContainer)Container).CancelHandler %>' />
                    </td>
                    <td>
                        <dxe:ASPxButton runat="server" ClientInstanceName="_dx" ID="btnDelete" Text="Löschen" UseSubmitBehavior="false"
                            ...
                            OnClientClick='<%# ((AppointmentFormTemplateContainer)Container).DeleteHandler %>'
